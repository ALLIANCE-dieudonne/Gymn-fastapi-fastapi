...
class Enroll(Base, TimestampMixin):
    ...
    membershipPlan = Column(String(100), nullable=False)
...
class Gallery(Base, TimestampMixin):
    ...
    img = Column(String(255), nullable=False)  # Path to image
    # timestamp is handled by TimestampMixin (created_at)
...
class Attendance(Base):
    ...
    logout = Column(String(100), nullable=False)    selectWorkout = Column(String(100), nullable=False)
